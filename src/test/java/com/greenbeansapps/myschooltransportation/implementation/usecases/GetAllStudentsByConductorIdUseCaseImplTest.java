...
public class GetAllStudentsByConductorIdUseCaseImplTest {
    ...
    StudentProjectionDto mockSecondStudent = new StudentProjectionDto(UUID.fromString("296c5a89-5a29-4549-bb48-f57ff7f04610"), "Ueslei Nogueira", "Colégio ETE Porto Digital", "3° Ano (Médio)", TransportationType.IDA_E_VOLTA, Shift.MANHA, 140, 18, mockResponsible, mockAddress);
