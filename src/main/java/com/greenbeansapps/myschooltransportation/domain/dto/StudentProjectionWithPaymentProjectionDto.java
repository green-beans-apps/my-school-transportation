...
public class StudentProjectionWithPaymentProjectionDto extends StudentProjectionDto{
    ...
    public StudentProjectionWithPaymentProjectionDto(UUID id, String name, String school, String grade, TransportationType transportationType, Shift shift, Integer monthlyPayment, String monthlyPaymentExpiration, Responsible responsible, Address address, List<PaymentProjectionDto> payments) {
