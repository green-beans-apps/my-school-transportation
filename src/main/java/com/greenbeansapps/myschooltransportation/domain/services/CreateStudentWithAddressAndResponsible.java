...
public interface CreateStudentWithAddressAndResponsible {
  ...
  public record StudentData(UUID id, String studentName, String school, String grade, String transportationType, Integer monthlyPayment, Integer monthlyPaymentExpiration,  String shift, UUID conductorId) { }
